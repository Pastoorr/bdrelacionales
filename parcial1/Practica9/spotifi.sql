...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-02-2025 a las 02:06:45
...
(4, 'Maluma', 'uan Luis Londoño Arias, conocido artísticamente como Maluma, es un cantante y compositor colombiano.​ Saltó a la fama en su país natal en 2011, gracias a los sencillos «Farandulera», «Obsesión», y «La temperatura»; y con «Carnaval», en el resto de América Latina'),
...
(2, 'Estudiantes\r\n\r\n\r\n1 cuenta Premium verificada\r\n\r\nDescuento para estudiantes que cumplen con los requi', 69),
...
(1, 'Alejandro Tizoc Beltrán', 'alejandro.tizoc23@cetis107.edu.mx', 2),
(2, 'Victor Emilio Ojeda Castro', 'victor.ojeda23@cetis107.edu.mx', 1),
(3, 'Luis Angel Perez Lozano', 'luis.perez23@cetis107.edu.mx', 3),
(4, 'Juan Pablo Ochoa Hermosillo', 'juan.ochoah23@cetis107.edu.mx', 4),
(5, 'Uriel Rodriguez Rojo', 'uriel.rodriguez23@cetis107.edu.mx', 2),
(6, 'Isaac Moreno Higuera', 'isaac.moreno23@cetis107.edu.mx', 1),
(7, 'Mateo Ibarra Gastelum', 'mateo.ibarra23@cetis107.edu.mx', 4),
(8, 'Sergio Braulio Martinez Felix', 'sergio.martinez23@cetis107.edu.mx', 3);
